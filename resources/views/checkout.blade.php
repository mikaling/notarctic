                    ...
                    <div class="col-lg-12">
                        <div class="order_box">
                            ...
                            @foreach(Cart::content() as $item)
                                    <li><a href="#">{{ $item->model->name }} <span class="middle">x {{ $item->qty }}</span> <span class="last">{{ $item->subtotal }}</span></a></li>
                                @endforeach
{{--                                <li><a href="#">Fresh Tomatoes <span class="middle">x 02</span> <span class="last">$720.00</span></a></li>--}}
{{--                                <li><a href="#">Fresh Brocoli <span class="middle">x 02</span> <span class="last">$720.00</span></a></li>--}}
                            </ul>
                            <ul class="list list_2">
                                <li><a href="#">Total items <span>{{ Cart::count() }}</span></a></li>
                                <li><a href="#">Subtotal <span>{{ Cart::subtotal() }}</span></a></li>
                                <li><a href="#">VAT <span>{{ Cart::tax() }}</span></a></li>
                            ...
                            <form action="api/mpesa/push" method="post">
                                <div class="payment_item">
                                    ...
                                    <input type="hidden" value="{{ Cart::total() }}" name="amount" class="form-control">
                                    <br>
                                    <div class="text-center">
