...
<head>
  ...
  <title>@yield('title-content')</title>
	<link rel="icon" href="{{asset('templateresources/img/Fevicon.png')}}img/Fevicon.png" type="image/png">
  ...
  <link rel="stylesheet" href="{{asset('templateresources/vendors/nice-select/nice-select.css')}}vendors/nice-select/nice-select.css">
